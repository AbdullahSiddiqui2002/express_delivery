        ...
        if(empty($email) || empty($password)){
            ...
            if($result){
                if(mysqli_num_rows($result) == 1){
                    ...
                    $regname = $row['firstname'] . " " . $row['lastname'];
                    $regemail = $row['email'];
...
?>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" style="color: #D54E16;">Login</h5>
                    <p class="text-center small">Enter your email & password to login</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate id="admin_signup_form" method="post">

  <div class="col-12">
    <label for="email" class="form-label">Your Email</label>
    <input type="email" id="myInput" name="email" class="form-control" id="email" required="required" data-bs-toggle="email" data-bs-target="#email-feedback">
    <div class="invalid-feedback" id="email-feedback">Please enter a valid Email address!</div>
  </div>

  <div class="col-12">
    <label for="password" class="form-label">Password</label>
    <input type="password" id="myInput" name="password" class="form-control" id="password" required="required" data-bs-toggle="password" data-bs-target="#password-feedback">
  ...
  <div class="col-12">
    <p class="small mb-0">Not a user? <a href="signup.php">create an account</a></p>
  </div>
</form>
