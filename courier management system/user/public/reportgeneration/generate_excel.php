...
if(isset($_SESSION['email'])){
    ...
    if($_GET['parcel_status'] && $_GET['from_date'] && $_GET['to_date'] && $_GET['user_email']){
...
$sql = "SELECT * FROM parcel WHERE `sender_email` = '$user_email' AND date(date_created) BETWEEN '$from_date' AND '$to_date'" . ($parcel_status != 'ALL' ? " AND parcel_status = $parcel_status" : "") . " ORDER BY unix_timestamp(date_created) ASC;";
