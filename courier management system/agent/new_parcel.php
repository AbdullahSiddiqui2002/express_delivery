...
if(isset($_SESSION['email'])){
  ...
  $agent_id_login = $_SESSION['id'];
  $read = "SELECT * FROM `agent` WHERE `id` = '$agent_id_login';";
$result_read = mysqli_query($connection,$read);
if($result_read){
    $row = mysqli_fetch_assoc($result_read);
}
$branch_id_login = $row['branch_id'];
    ...
    <section class="section my-5">
      <form class="row g-3"  method="post" >
        ...
        <div class="col-md-12 my-2">
          ...
          <textarea class="form-control mb-3" name="parcel_description" rows="5" placeholder="Enter parcel description"></textarea>
        </div>
        ...
        <div class="col-md-6">
                ...
                <option value=""></option>
                  <?php
                    ...
                    $read = "SELECT *,concat(street,', ',city,', ',state,', ',zip_code,', ',country) as address FROM branches WHERE `id` = '$branch_id_login';";
