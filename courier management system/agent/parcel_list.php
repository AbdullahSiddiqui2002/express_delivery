        ...
        <div class="col-lg-12">
            <table class="table table-bordered text-center" id="list">
                ...
                <tbody id="branch_tablebody">
                    <?php
                    if ($_GET['status'] == "All") {
                        $read = "SELECT * FROM `parcel` WHERE `agent_id` = '$agent_id' ORDER BY id DESC;";
                    } else {
                        $status = $_GET['status'];
                        $read = "SELECT * FROM `parcel` where parcel_status = '$status' AND `agent_id` = '$agent_id' ORDER BY id DESC;";
                    }
