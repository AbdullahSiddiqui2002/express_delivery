...
<!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#branches" data-bs-toggle="collapse" href="#" style="background-color: #343A40 !important; color: #c2c7d0 !important;">
          <i class="bi bi-building" style="color: #c2c7d0 !important;"></i><span>Branch</span><i class="bi bi-chevron-down ms-auto" style="color: #c2c7d0 !important;"></i>
        </a>
        <ul id="branches" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="new_branch.php" style="color: #c2c7d0 !important;">
              <i class="bi bi-chevron-right" style="font-size: 1rem;"></i></i><span>Add New</span>
            </a>
          </li>
          <li>
            <a href="branch_list.php" style="color: #c2c7d0 !important;">
              <i class="bi bi-chevron-right" style="font-size: 1rem;"></i><span>List</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#agent" data-bs-toggle="collapse" href="#" style="background-color: #343A40 !important; color: #c2c7d0 !important;">
          <i class="bi bi-people-fill" style="color: #c2c7d0 !important;"></i><span>Agent</span><i class="bi bi-chevron-down ms-auto" style="color: #c2c7d0 !important;"></i>
        </a>
        <ul id="agent" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="new_agent.php" style="color: #c2c7d0 !important;">
              <i class="bi bi-chevron-right" style="font-size: 1rem;"></i><span>Add New</span>
            </a>
          </li>
          <li>
            <a href="agent_list.php" style="color: #c2c7d0 !important;">
              <i class="bi bi-chevron-right" style="font-size: 1rem;"></i><span>List</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#user" data-bs-toggle="collapse" href="#" style="background-color: #343A40 !important; color: #c2c7d0 !important;">
          <i class="bi bi-people-fill" style="color: #c2c7d0 !important;"></i><span>User</span><i class="bi bi-chevron-down ms-auto" style="color: #c2c7d0 !important;"></i>
        </a>
        <ul id="user" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="user_list.php" style="color: #c2c7d0 !important;">
              <i class="bi bi-chevron-right" style="font-size: 1rem;"></i><span>List</span>
            </a>
          </li>
          <li>
            <a href="user_messages.php" style="color: #c2c7d0 !important;">
              <i class="bi bi-chevron-right" style="font-size: 1rem;"></i><span>Messages</span>
            </a>
          </li>
          <li>
            <a href="subscribed_user.php" style="color: #c2c7d0 !important;">
              <i class="bi bi-chevron-right" style="font-size: 1rem;"></i><span>Subscribed Users</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
