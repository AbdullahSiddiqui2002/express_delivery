...
<section class="section my-5">
  <form class="row g-3"  method="post" action="update_parceldata.php">
    ...
    <div class="col-md-6 my-2 pe-5">
      ...
      <input type="text" name="sender_name" class="form-control mb-3" value="<?php echo $sender_name ?>" >

      <label for="sender_email" class="form-label">Email</label>
      <input type="text" name="sender_email" class="form-control mb-3" value="<?php echo $sender_email ?>" >

      <label for="sender_address" class="form-label">Address</label>
      <input type="text" name="sender_address" class="form-control mb-3" value="<?php echo $sender_address ?>" >

      <label for="sender_contact" class="form-label">Contact#</label>
      <input type="text" name="sender_contact" class="form-control mb-3" value="<?php echo $sender_contact ?>" >
    </div>
    
    <div class="col-md-6 my-2 ps-5" style="border-left: 1px solid gray;">
      <h4>Recipient Information</h4>
      <label for="recipient_name" class="form-label">Name</label>
      <input type="text" name="recipient_name" class="form-control  mb-3" value="<?php echo $recipient_name ?>" >

      <label for="recipient_email" class="form-label">Email</label>
      <input type="text" name="recipient_email" class="form-control mb-3" value="<?php echo $recipient_email ?>" >

      <label for="recipient_address" class="form-label">Address</label>
      <input type="text" name="recipient_address" class="form-control  mb-3" value="<?php echo $recipient_address ?>" >

      <label for="recipient_contact" class="form-label">Contact#</label>
      <input type="text" name="recipient_contact" class="form-control  mb-3" value="<?php echo $recipient_contact ?>" >
    </div>
    ...
    <div class="col-md-12 my-2">
      ...
      <textarea class="form-control mb-3" name="parcel_description" rows="5" placeholder="Enter parcel description" ><?php echo  $parcel_description ?></textarea>
    </div>
    ...
    <label for="weight" class="form-label">Weight (Rs. 500 Per Kg)</label>
      <input type="number" name="weight" class="form-control mb-3"  placeholder="Enter Weight in Kg" id="weight" value="<?php echo $weight ?>">
