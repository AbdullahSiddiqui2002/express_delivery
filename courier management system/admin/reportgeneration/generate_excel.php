...
if(isset($_SESSION['email'])){
    ...
    if($_GET['parcel_status'] && $_GET['from_date'] && $_GET['to_date']){
...
$sql = "SELECT * FROM parcel WHERE date(date_created) BETWEEN '$from_date' AND '$to_date'" . ($parcel_status != 'ALL' ? " AND parcel_status = $parcel_status" : "") . " ORDER BY unix_timestamp(date_created) ASC;";
